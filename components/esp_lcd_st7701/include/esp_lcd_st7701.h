...
#define ST7701_480_360_PANEL_60HZ_DPI_CONFIG(px_format)  \
    ...
    /* Local migration for ESP-IDF 6.x: the removed `.flags.use_dma2d` is
       replaced by an explicit esp_lcd_dpi_panel_enable_dma2d() call after
       the panel is created (done by the application). */
