...
// Local change: disabled. This experimental module (upstream 3cc5269) fails
// against bindings generated through the idf.py cmake driver on ESP-IDF 6.1,
// where most socket/libc constants are absent from the bindings. Re-enable
// once upstream makes it pass there.
// #[cfg(feature = "std")]
// mod libc;
